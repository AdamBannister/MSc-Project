    ...
    if len(args) == 1:
        ...
        for i in range(0, iMax):
            ...
            if (metab.getStatus() != CModelEntity.FIXED):
                ...
                # particle number
                body.push_back(CRegisteredObjectName(
                    metab.getObject(CCopasiObjectName("Reference=Concentration")).getCN().getString()))
        ...
        trajectoryTask.getReport().setTarget("ModelScript1.txt")
        ...
        sys.stderr.write("Usage: ModelScript1 SBMLFILE\n")
        return 1;
