...
def main(args):
    ...
    'minimum_concentration' is the minimum concentrentration of input.
    'max_concentration' is the maximum concentration of input.
    ...
    try:
        ...
        print("Incorrect type for argument(s). Arguments: filename as string, min_concentration as integer \
                or float, max_concentration as integer or float. Optional: iterations as integer (default 100).")
